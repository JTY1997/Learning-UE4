...
// End Cross Module References
	...
	uint32 Get_Z_Construct_UEnum_AndroidRuntimeSettings_EAndroidGraphicsDebugger_Hash() { return 3151987548U; }
	...
	uint32 Get_Z_Construct_UEnum_AndroidRuntimeSettings_EGoogleVRCaps_Hash() { return 3429100530U; }
	UEnum* Z_Construct_UEnum_AndroidRuntimeSettings_EGoogleVRCaps()
	{
		...
		if (!ReturnEnum)
		{
			...
			const UE4CodeGen_Private::FMetaDataPairParam Enum_MetaDataParams[] = {
				...
				{ "Daydream63.Name", "EGoogleVRCaps::Daydream63" },
				...
				{ "Daydream66.Name", "EGoogleVRCaps::Daydream66" },
	...
	uint32 Get_Z_Construct_UEnum_AndroidRuntimeSettings_EGoogleVRMode_Hash() { return 4257732364U; }
	UEnum* Z_Construct_UEnum_AndroidRuntimeSettings_EGoogleVRMode()
	{
		...
		if (!ReturnEnum)
		{
			...
			const UE4CodeGen_Private::FMetaDataPairParam Enum_MetaDataParams[] = {
				...
				{ "DaydreamAndCardboard.Name", "EGoogleVRMode::DaydreamAndCardboard" },
	...
	uint32 Get_Z_Construct_UEnum_AndroidRuntimeSettings_EAndroidAudio_Hash() { return 671558010U; }
	...
	static UEnum* EOculusMobileDevice_StaticEnum()
	{
		...
		if (!Singleton)
		{
			Singleton = GetStaticEnum(Z_Construct_UEnum_AndroidRuntimeSettings_EOculusMobileDevice, Z_Construct_UPackage__Script_AndroidRuntimeSettings(), TEXT("EOculusMobileDevice"));
		}
		return Singleton;
	}
	...
	static FCompiledInDeferEnum Z_CompiledInDeferEnum_UEnum_EOculusMobileDevice(EOculusMobileDevice_StaticEnum, TEXT("/Script/AndroidRuntimeSettings"), TEXT("EOculusMobileDevice"), false, nullptr, nullptr);
	uint32 Get_Z_Construct_UEnum_AndroidRuntimeSettings_EOculusMobileDevice_Hash() { return 2101083333U; }
	UEnum* Z_Construct_UEnum_AndroidRuntimeSettings_EOculusMobileDevice()
	{
#if WITH_HOT_RELOAD
		UPackage* Outer = Z_Construct_UPackage__Script_AndroidRuntimeSettings();
		static UEnum* ReturnEnum = FindExistingEnumIfHotReloadOrDynamic(Outer, TEXT("EOculusMobileDevice"), 0, Get_Z_Construct_UEnum_AndroidRuntimeSettings_EOculusMobileDevice_Hash(), false);
#else
		static UEnum* ReturnEnum = nullptr;
#endif // WITH_HOT_RELOAD
		if (!ReturnEnum)
		{
			static const UE4CodeGen_Private::FEnumeratorParam Enumerators[] = {
				{ "EOculusMobileDevice::GearGo", (int64)EOculusMobileDevice::GearGo },
			...
			const UE4CodeGen_Private::FMetaDataPairParam Enum_MetaDataParams[] = {
				...
				{ "GearGo.Comment", "/** Package for Oculus Go / Gear VR */" },
				{ "GearGo.DisplayName", "Oculus Go / Gear VR" },
				{ "GearGo.Name", "EOculusMobileDevice::GearGo" },
				{ "GearGo.ToolTip", "Package for Oculus Go / Gear VR" },
				{ "ModuleRelativePath", "Classes/AndroidRuntimeSettings.h" },
	...
	uint32 Get_Z_Construct_UEnum_AndroidRuntimeSettings_EAndroidInstallLocation_Hash() { return 1430452154U; }
	...
	uint32 Get_Z_Construct_UEnum_AndroidRuntimeSettings_EAndroidDepthBufferPreference_Hash() { return 738222029U; }
	...
	uint32 Get_Z_Construct_UEnum_AndroidRuntimeSettings_EAndroidScreenOrientation_Hash() { return 3739847127U; }
...
static struct FScriptStruct_AndroidRuntimeSettings_StaticRegisterNativesFGooglePlayLeaderboardMapping
{
	...
	uint32 Get_Z_Construct_UScriptStruct_FGooglePlayLeaderboardMapping_Hash() { return 2152061027U; }
...
static struct FScriptStruct_AndroidRuntimeSettings_StaticRegisterNativesFGooglePlayAchievementMapping
{
	...
	uint32 Get_Z_Construct_UScriptStruct_FGooglePlayAchievementMapping_Hash() { return 4278655534U; }
...
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam NewProp_bControllersBlockDeviceFeedback_MetaData[];
#endif
		static void NewProp_bControllersBlockDeviceFeedback_SetBit(void* Obj);
		static const UE4CodeGen_Private::FBoolPropertyParams NewProp_bControllersBlockDeviceFeedback;
#if WITH_METADATA
...
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam NewProp_bForceLDLinker_MetaData[];
#endif
		static void NewProp_bForceLDLinker_SetBit(void* Obj);
		static const UE4CodeGen_Private::FBoolPropertyParams NewProp_bForceLDLinker;
#if WITH_METADATA
...
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam NewProp_bSupportsVulkanSM5_MetaData[];
#endif
		static void NewProp_bSupportsVulkanSM5_SetBit(void* Obj);
		static const UE4CodeGen_Private::FBoolPropertyParams NewProp_bSupportsVulkanSM5;
#if WITH_METADATA
...
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam NewProp_PackageForOculusMobile_MetaData[];
#endif
		static const UE4CodeGen_Private::FArrayPropertyParams NewProp_PackageForOculusMobile;
		static const UE4CodeGen_Private::FBytePropertyParams NewProp_PackageForOculusMobile_Inner;
#if WITH_METADATA
...
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam NewProp_bBundleDensitySplit_MetaData[];
#endif
		static void NewProp_bBundleDensitySplit_SetBit(void* Obj);
		static const UE4CodeGen_Private::FBoolPropertyParams NewProp_bBundleDensitySplit;
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam NewProp_bBundleLanguageSplit_MetaData[];
#endif
		static void NewProp_bBundleLanguageSplit_SetBit(void* Obj);
		static const UE4CodeGen_Private::FBoolPropertyParams NewProp_bBundleLanguageSplit;
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam NewProp_bBundleABISplit_MetaData[];
#endif
		static void NewProp_bBundleABISplit_SetBit(void* Obj);
		static const UE4CodeGen_Private::FBoolPropertyParams NewProp_bBundleABISplit;
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam NewProp_bEnableUniversalAPK_MetaData[];
#endif
		static void NewProp_bEnableUniversalAPK_SetBit(void* Obj);
		static const UE4CodeGen_Private::FBoolPropertyParams NewProp_bEnableUniversalAPK;
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam NewProp_bEnableBundle_MetaData[];
#endif
		static void NewProp_bEnableBundle_SetBit(void* Obj);
		static const UE4CodeGen_Private::FBoolPropertyParams NewProp_bEnableBundle;
#if WITH_METADATA
...
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam NewProp_bRestoreNotificationsOnReboot_MetaData[];
#endif
		static void NewProp_bRestoreNotificationsOnReboot_SetBit(void* Obj);
		static const UE4CodeGen_Private::FBoolPropertyParams NewProp_bRestoreNotificationsOnReboot;
#if WITH_METADATA
...
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam NewProp_bPublicLogFiles_MetaData[];
#endif
		static void NewProp_bPublicLogFiles_SetBit(void* Obj);
		static const UE4CodeGen_Private::FBoolPropertyParams NewProp_bPublicLogFiles;
#if WITH_METADATA
...
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam NewProp_bAllowPatchOBBFile_MetaData[];
#endif
		static void NewProp_bAllowPatchOBBFile_SetBit(void* Obj);
		static const UE4CodeGen_Private::FBoolPropertyParams NewProp_bAllowPatchOBBFile;
#if WITH_METADATA
...
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam NewProp_bForceSmallOBBFiles_MetaData[];
#endif
		static void NewProp_bForceSmallOBBFiles_SetBit(void* Obj);
		static const UE4CodeGen_Private::FBoolPropertyParams NewProp_bForceSmallOBBFiles;
#if WITH_METADATA
...
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam NewProp_StoreVersionOffsetX8664_MetaData[];
#endif
		static const UE4CodeGen_Private::FIntPropertyParams NewProp_StoreVersionOffsetX8664;
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam NewProp_StoreVersionOffsetArm64_MetaData[];
#endif
		static const UE4CodeGen_Private::FIntPropertyParams NewProp_StoreVersionOffsetArm64;
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam NewProp_StoreVersionOffsetArmV7_MetaData[];
#endif
		static const UE4CodeGen_Private::FIntPropertyParams NewProp_StoreVersionOffsetArmV7;
#if WITH_METADATA
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UAndroidRuntimeSettings_Statics::NewProp_SoundCueCookQualityIndex_MetaData[] = {
		{ "Category", "Audio|CookOverrides" },
...
#endif
	const UE4CodeGen_Private::FIntPropertyParams Z_Construct_UClass_UAndroidRuntimeSettings_Statics::NewProp_SoundCueCookQualityIndex = { "SoundCueCookQualityIndex", nullptr, (EPropertyFlags)0x0010000000044001, UE4CodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UAndroidRuntimeSettings, SoundCueCookQualityIndex), METADATA_PARAMS(Z_Construct_UClass_UAndroidRuntimeSettings_Statics::NewProp_SoundCueCookQualityIndex_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UAndroidRuntimeSettings_Statics::NewProp_SoundCueCookQualityIndex_MetaData)) };
#if WITH_METADATA
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UAndroidRuntimeSettings_Statics::NewProp_CacheSizeKB_MetaData[] = {
...
#endif
	const UE4CodeGen_Private::FIntPropertyParams Z_Construct_UClass_UAndroidRuntimeSettings_Statics::NewProp_CacheSizeKB = { "CacheSizeKB", nullptr, (EPropertyFlags)0x0010000000044001, UE4CodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UAndroidRuntimeSettings, CacheSizeKB), METADATA_PARAMS(Z_Construct_UClass_UAndroidRuntimeSettings_Statics::NewProp_CacheSizeKB_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UAndroidRuntimeSettings_Statics::NewProp_CacheSizeKB_MetaData)) };
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UAndroidRuntimeSettings_Statics::NewProp_bUseAudioStreamCaching_MetaData[] = {
		{ "Category", "Audio|CookOverrides" },
...
#endif
	void Z_Construct_UClass_UAndroidRuntimeSettings_Statics::NewProp_bUseAudioStreamCaching_SetBit(void* Obj)
	{
		((UAndroidRuntimeSettings*)Obj)->bUseAudioStreamCaching = 1;
	}
	const UE4CodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UAndroidRuntimeSettings_Statics::NewProp_bUseAudioStreamCaching = { "bUseAudioStreamCaching", nullptr, (EPropertyFlags)0x0010000000044001, UE4CodeGen_Private::EPropertyGenFlags::Bool | UE4CodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(UAndroidRuntimeSettings), &Z_Construct_UClass_UAndroidRuntimeSettings_Statics::NewProp_bUseAudioStreamCaching_SetBit, METADATA_PARAMS(Z_Construct_UClass_UAndroidRuntimeSettings_Statics::NewProp_bUseAudioStreamCaching_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UAndroidRuntimeSettings_Statics::NewProp_bUseAudioStreamCaching_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FBytePropertyParams Z_Construct_UClass_UAndroidRuntimeSettings_Statics::NewProp_AndroidAudio = { "AndroidAudio", nullptr, (EPropertyFlags)0x0010000000044001, UE4CodeGen_Private::EPropertyGenFlags::Byte, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UAndroidRuntimeSettings, AndroidAudio), Z_Construct_UEnum_AndroidRuntimeSettings_EAndroidAudio, METADATA_PARAMS(Z_Construct_UClass_UAndroidRuntimeSettings_Statics::NewProp_AndroidAudio_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UAndroidRuntimeSettings_Statics::NewProp_AndroidAudio_MetaData)) };
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UAndroidRuntimeSettings_Statics::NewProp_bControllersBlockDeviceFeedback_MetaData[] = {
		{ "Category", "Input" },
	...
	const UE4CodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UAndroidRuntimeSettings_Statics::NewProp_bControllersBlockDeviceFeedback = { "bControllersBlockDeviceFeedback", nullptr, (EPropertyFlags)0x0010000000044001, UE4CodeGen_Private::EPropertyGenFlags::Bool | UE4CodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(UAndroidRuntimeSettings), &Z_Construct_UClass_UAndroidRuntimeSettings_Statics::NewProp_bControllersBlockDeviceFeedback_SetBit, METADATA_PARAMS(Z_Construct_UClass_UAndroidRuntimeSettings_Statics::NewProp_bControllersBlockDeviceFeedback_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UAndroidRuntimeSettings_Statics::NewProp_bControllersBlockDeviceFeedback_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UAndroidRuntimeSettings_Statics::NewProp_AdMobAdUnitIDs = { "AdMobAdUnitIDs", nullptr, (EPropertyFlags)0x0010000000044001, UE4CodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UAndroidRuntimeSettings, AdMobAdUnitIDs), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UClass_UAndroidRuntimeSettings_Statics::NewProp_AdMobAdUnitIDs_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UAndroidRuntimeSettings_Statics::NewProp_AdMobAdUnitIDs_MetaData)) };
...
#endif
	const UE4CodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UAndroidRuntimeSettings_Statics::NewProp_LeaderboardMap = { "LeaderboardMap", nullptr, (EPropertyFlags)0x0010000000044001, UE4CodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UAndroidRuntimeSettings, LeaderboardMap), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UClass_UAndroidRuntimeSettings_Statics::NewProp_LeaderboardMap_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UAndroidRuntimeSettings_Statics::NewProp_LeaderboardMap_MetaData)) };
...
#endif
	const UE4CodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UAndroidRuntimeSettings_Statics::NewProp_AchievementMap = { "AchievementMap", nullptr, (EPropertyFlags)0x0010000000044001, UE4CodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UAndroidRuntimeSettings, AchievementMap), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UClass_UAndroidRuntimeSettings_Statics::NewProp_AchievementMap_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UAndroidRuntimeSettings_Statics::NewProp_AchievementMap_MetaData)) };
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UAndroidRuntimeSettings_Statics::NewProp_bForceLDLinker_MetaData[] = {
		{ "Category", "AdvancedBuild" },
		{ "Comment", "// Use legacy ld instead of new lld linker.\n" },
		{ "DisplayName", "Force linking to use ld instead of lld" },
		{ "ModuleRelativePath", "Classes/AndroidRuntimeSettings.h" },
		{ "ToolTip", "Use legacy ld instead of new lld linker." },
	};
#endif
	void Z_Construct_UClass_UAndroidRuntimeSettings_Statics::NewProp_bForceLDLinker_SetBit(void* Obj)
	{
		((UAndroidRuntimeSettings*)Obj)->bForceLDLinker = 1;
	}
	const UE4CodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UAndroidRuntimeSettings_Statics::NewProp_bForceLDLinker = { "bForceLDLinker", nullptr, (EPropertyFlags)0x0010000000044001, UE4CodeGen_Private::EPropertyGenFlags::Bool | UE4CodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(UAndroidRuntimeSettings), &Z_Construct_UClass_UAndroidRuntimeSettings_Statics::NewProp_bForceLDLinker_SetBit, METADATA_PARAMS(Z_Construct_UClass_UAndroidRuntimeSettings_Statics::NewProp_bForceLDLinker_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UAndroidRuntimeSettings_Statics::NewProp_bForceLDLinker_MetaData)) };
#if WITH_METADATA
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UAndroidRuntimeSettings_Statics::NewProp_bSupportsVulkanSM5_MetaData[] = {
		{ "Category", "Build" },
	...
	const UE4CodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UAndroidRuntimeSettings_Statics::NewProp_bSupportsVulkanSM5 = { "bSupportsVulkanSM5", nullptr, (EPropertyFlags)0x0010000000044001, UE4CodeGen_Private::EPropertyGenFlags::Bool | UE4CodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(UAndroidRuntimeSettings), &Z_Construct_UClass_UAndroidRuntimeSettings_Statics::NewProp_bSupportsVulkanSM5_SetBit, METADATA_PARAMS(Z_Construct_UClass_UAndroidRuntimeSettings_Statics::NewProp_bSupportsVulkanSM5_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UAndroidRuntimeSettings_Statics::NewProp_bSupportsVulkanSM5_MetaData)) };
#if WITH_METADATA
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UAndroidRuntimeSettings_Statics::NewProp_bBuildForES31_MetaData[] = {
		{ "Category", "Build" },
		{ "Comment", "// Include shaders for devices supporting OpenGL ES 3.1 and above (default)\n" },
		{ "DisplayName", "Support OpenGL ES3.1" },
		{ "ModuleRelativePath", "Classes/AndroidRuntimeSettings.h" },
		{ "ToolTip", "Include shaders for devices supporting OpenGL ES 3.1 and above (default)" },
	};
#endif
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UAndroidRuntimeSettings_Statics::NewProp_bBuildForArmV7_MetaData[] = {
		{ "Category", "Build" },
		{ "Comment", "// Enable ArmV7 support? (this will be used if all type are unchecked)\n" },
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UAndroidRuntimeSettings_Statics::NewProp_bGoogleVRSustainedPerformance_MetaData[] = {
		...
		{ "Comment", "// Configure the Android to run in sustained performance with lower max speeds, but no FPS fluctuations due to temperature\n" },
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UAndroidRuntimeSettings_Statics::NewProp_GoogleVRCaps_MetaData[] = {
		{ "Category", "Advanced APK Packaging" },
		{ "Comment", "// Configure AndroidManifest.xml to support specific hardward configurations, position and orientation of the head and controller.\n" },
...
#endif
	const UE4CodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UAndroidRuntimeSettings_Statics::NewProp_GoogleVRCaps = { "GoogleVRCaps", nullptr, (EPropertyFlags)0x0010000000044001, UE4CodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UAndroidRuntimeSettings, GoogleVRCaps), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UClass_UAndroidRuntimeSettings_Statics::NewProp_GoogleVRCaps_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UAndroidRuntimeSettings_Statics::NewProp_GoogleVRCaps_MetaData)) };
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UAndroidRuntimeSettings_Statics::NewProp_bRemoveOSIG_MetaData[] = {
		{ "Category", "Advanced APK Packaging" },
		{ "Comment", "// Removes Oculus Signature Files (osig) from APK if Gear VR APK signed for distribution and enables entitlement checker\n" },
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UAndroidRuntimeSettings_Statics::NewProp_PackageForOculusMobile_MetaData[] = {
		{ "Category", "Advanced APK Packaging" },
...
#endif
	const UE4CodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UAndroidRuntimeSettings_Statics::NewProp_PackageForOculusMobile = { "PackageForOculusMobile", nullptr, (EPropertyFlags)0x0010000000044001, UE4CodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UAndroidRuntimeSettings, PackageForOculusMobile), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UClass_UAndroidRuntimeSettings_Statics::NewProp_PackageForOculusMobile_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UAndroidRuntimeSettings_Statics::NewProp_PackageForOculusMobile_MetaData)) };
	const UE4CodeGen_Private::FBytePropertyParams Z_Construct_UClass_UAndroidRuntimeSettings_Statics::NewProp_PackageForOculusMobile_Inner = { "PackageForOculusMobile", nullptr, (EPropertyFlags)0x0000000000004000, UE4CodeGen_Private::EPropertyGenFlags::Byte, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, Z_Construct_UEnum_AndroidRuntimeSettings_EOculusMobileDevice, METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UAndroidRuntimeSettings_Statics::NewProp_ExtraPermissions = { "ExtraPermissions", nullptr, (EPropertyFlags)0x0010000000044001, UE4CodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UAndroidRuntimeSettings, ExtraPermissions), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UClass_UAndroidRuntimeSettings_Statics::NewProp_ExtraPermissions_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UAndroidRuntimeSettings_Statics::NewProp_ExtraPermissions_MetaData)) };
...
#endif
	const UE4CodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UAndroidRuntimeSettings_Statics::NewProp_ExtraActivityNodeTags = { "ExtraActivityNodeTags", nullptr, (EPropertyFlags)0x0010000000044001, UE4CodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UAndroidRuntimeSettings, ExtraActivityNodeTags), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UClass_UAndroidRuntimeSettings_Statics::NewProp_ExtraActivityNodeTags_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UAndroidRuntimeSettings_Statics::NewProp_ExtraActivityNodeTags_MetaData)) };
...
#endif
	const UE4CodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UAndroidRuntimeSettings_Statics::NewProp_ExtraApplicationNodeTags = { "ExtraApplicationNodeTags", nullptr, (EPropertyFlags)0x0010000000044001, UE4CodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UAndroidRuntimeSettings, ExtraApplicationNodeTags), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UClass_UAndroidRuntimeSettings_Statics::NewProp_ExtraApplicationNodeTags_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UAndroidRuntimeSettings_Statics::NewProp_ExtraApplicationNodeTags_MetaData)) };
...
#endif
	const UE4CodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UAndroidRuntimeSettings_Statics::NewProp_ExtraManifestNodeTags = { "ExtraManifestNodeTags", nullptr, (EPropertyFlags)0x0010000000044001, UE4CodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UAndroidRuntimeSettings, ExtraManifestNodeTags), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UClass_UAndroidRuntimeSettings_Statics::NewProp_ExtraManifestNodeTags_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UAndroidRuntimeSettings_Statics::NewProp_ExtraManifestNodeTags_MetaData)) };
	const UE4CodeGen_Private::FStrPropertyParams Z_Construct_UClass_UAndroidRuntimeSettings_Statics::NewProp_ExtraManifestNodeTags_Inner = { "ExtraManifestNodeTags", nullptr, (EPropertyFlags)0x0000000000004000, UE4CodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UAndroidRuntimeSettings_Statics::NewProp_bBundleDensitySplit_MetaData[] = {
	...
	const UE4CodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UAndroidRuntimeSettings_Statics::NewProp_bBundleDensitySplit = { "bBundleDensitySplit", nullptr, (EPropertyFlags)0x0010000000044001, UE4CodeGen_Private::EPropertyGenFlags::Bool | UE4CodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(UAndroidRuntimeSettings), &Z_Construct_UClass_UAndroidRuntimeSettings_Statics::NewProp_bBundleDensitySplit_SetBit, METADATA_PARAMS(Z_Construct_UClass_UAndroidRuntimeSettings_Statics::NewProp_bBundleDensitySplit_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UAndroidRuntimeSettings_Statics::NewProp_bBundleDensitySplit_MetaData)) };
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UAndroidRuntimeSettings_Statics::NewProp_bBundleLanguageSplit_MetaData[] = {
		{ "Category", "App Bundles" },
	...
	const UE4CodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UAndroidRuntimeSettings_Statics::NewProp_bBundleLanguageSplit = { "bBundleLanguageSplit", nullptr, (EPropertyFlags)0x0010000000044001, UE4CodeGen_Private::EPropertyGenFlags::Bool | UE4CodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(UAndroidRuntimeSettings), &Z_Construct_UClass_UAndroidRuntimeSettings_Statics::NewProp_bBundleLanguageSplit_SetBit, METADATA_PARAMS(Z_Construct_UClass_UAndroidRuntimeSettings_Statics::NewProp_bBundleLanguageSplit_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UAndroidRuntimeSettings_Statics::NewProp_bBundleLanguageSplit_MetaData)) };
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UAndroidRuntimeSettings_Statics::NewProp_bBundleABISplit_MetaData[] = {
		{ "Category", "App Bundles" },
	...
	const UE4CodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UAndroidRuntimeSettings_Statics::NewProp_bBundleABISplit = { "bBundleABISplit", nullptr, (EPropertyFlags)0x0010000000044001, UE4CodeGen_Private::EPropertyGenFlags::Bool | UE4CodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(UAndroidRuntimeSettings), &Z_Construct_UClass_UAndroidRuntimeSettings_Statics::NewProp_bBundleABISplit_SetBit, METADATA_PARAMS(Z_Construct_UClass_UAndroidRuntimeSettings_Statics::NewProp_bBundleABISplit_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UAndroidRuntimeSettings_Statics::NewProp_bBundleABISplit_MetaData)) };
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UAndroidRuntimeSettings_Statics::NewProp_bEnableUniversalAPK_MetaData[] = {
		{ "Category", "App Bundles" },
	...
	const UE4CodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UAndroidRuntimeSettings_Statics::NewProp_bEnableUniversalAPK = { "bEnableUniversalAPK", nullptr, (EPropertyFlags)0x0010000000044001, UE4CodeGen_Private::EPropertyGenFlags::Bool | UE4CodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(UAndroidRuntimeSettings), &Z_Construct_UClass_UAndroidRuntimeSettings_Statics::NewProp_bEnableUniversalAPK_SetBit, METADATA_PARAMS(Z_Construct_UClass_UAndroidRuntimeSettings_Statics::NewProp_bEnableUniversalAPK_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UAndroidRuntimeSettings_Statics::NewProp_bEnableUniversalAPK_MetaData)) };
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UAndroidRuntimeSettings_Statics::NewProp_bEnableBundle_MetaData[] = {
		{ "Category", "App Bundles" },
	...
	const UE4CodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UAndroidRuntimeSettings_Statics::NewProp_bEnableBundle = { "bEnableBundle", nullptr, (EPropertyFlags)0x0010000000044001, UE4CodeGen_Private::EPropertyGenFlags::Bool | UE4CodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(UAndroidRuntimeSettings), &Z_Construct_UClass_UAndroidRuntimeSettings_Statics::NewProp_bEnableBundle_SetBit, METADATA_PARAMS(Z_Construct_UClass_UAndroidRuntimeSettings_Statics::NewProp_bEnableBundle_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UAndroidRuntimeSettings_Statics::NewProp_bEnableBundle_MetaData)) };
#if WITH_METADATA
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UAndroidRuntimeSettings_Statics::NewProp_bRestoreNotificationsOnReboot_MetaData[] = {
		{ "Category", "APK Packaging" },
	...
	const UE4CodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UAndroidRuntimeSettings_Statics::NewProp_bRestoreNotificationsOnReboot = { "bRestoreNotificationsOnReboot", nullptr, (EPropertyFlags)0x0010000000044001, UE4CodeGen_Private::EPropertyGenFlags::Bool | UE4CodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(UAndroidRuntimeSettings), &Z_Construct_UClass_UAndroidRuntimeSettings_Statics::NewProp_bRestoreNotificationsOnReboot_SetBit, METADATA_PARAMS(Z_Construct_UClass_UAndroidRuntimeSettings_Statics::NewProp_bRestoreNotificationsOnReboot_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UAndroidRuntimeSettings_Statics::NewProp_bRestoreNotificationsOnReboot_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FBytePropertyParams Z_Construct_UClass_UAndroidRuntimeSettings_Statics::NewProp_Orientation = { "Orientation", nullptr, (EPropertyFlags)0x0010000000044001, UE4CodeGen_Private::EPropertyGenFlags::Byte, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UAndroidRuntimeSettings, Orientation), Z_Construct_UEnum_AndroidRuntimeSettings_EAndroidScreenOrientation, METADATA_PARAMS(Z_Construct_UClass_UAndroidRuntimeSettings_Statics::NewProp_Orientation_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UAndroidRuntimeSettings_Statics::NewProp_Orientation_MetaData)) };
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UAndroidRuntimeSettings_Statics::NewProp_bPublicLogFiles_MetaData[] = {
		{ "Category", "APK Packaging" },
		{ "Comment", "// If checked, log files will always be placed in a publicly available directory (either /sdcard/Android or /sdcard/UE4Game).\n// You may require WRITE_EXTERNAL_STORAGE permission if you do not use ExternalFilesDir checkbox in android api 23+\n" },
		{ "DisplayName", "Make log files always publicly accessible?" },
		{ "ModuleRelativePath", "Classes/AndroidRuntimeSettings.h" },
		{ "ToolTip", "If checked, log files will always be placed in a publicly available directory (either /sdcard/Android or /sdcard/UE4Game).\nYou may require WRITE_EXTERNAL_STORAGE permission if you do not use ExternalFilesDir checkbox in android api 23+" },
	};
#endif
	...
	const UE4CodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UAndroidRuntimeSettings_Statics::NewProp_bPublicLogFiles = { "bPublicLogFiles", nullptr, (EPropertyFlags)0x0010000000044001, UE4CodeGen_Private::EPropertyGenFlags::Bool | UE4CodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(UAndroidRuntimeSettings), &Z_Construct_UClass_UAndroidRuntimeSettings_Statics::NewProp_bPublicLogFiles_SetBit, METADATA_PARAMS(Z_Construct_UClass_UAndroidRuntimeSettings_Statics::NewProp_bPublicLogFiles_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UAndroidRuntimeSettings_Statics::NewProp_bPublicLogFiles_MetaData)) };
#if WITH_METADATA
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UAndroidRuntimeSettings_Statics::NewProp_bAllowPatchOBBFile_MetaData[] = {
		{ "Category", "APK Packaging" },
	...
	const UE4CodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UAndroidRuntimeSettings_Statics::NewProp_bAllowPatchOBBFile = { "bAllowPatchOBBFile", nullptr, (EPropertyFlags)0x0010000000044001, UE4CodeGen_Private::EPropertyGenFlags::Bool | UE4CodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(UAndroidRuntimeSettings), &Z_Construct_UClass_UAndroidRuntimeSettings_Statics::NewProp_bAllowPatchOBBFile_SetBit, METADATA_PARAMS(Z_Construct_UClass_UAndroidRuntimeSettings_Statics::NewProp_bAllowPatchOBBFile_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UAndroidRuntimeSettings_Statics::NewProp_bAllowPatchOBBFile_MetaData)) };
#if WITH_METADATA
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UAndroidRuntimeSettings_Statics::NewProp_bForceSmallOBBFiles_MetaData[] = {
		{ "Category", "APK Packaging" },
	...
	const UE4CodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UAndroidRuntimeSettings_Statics::NewProp_bForceSmallOBBFiles = { "bForceSmallOBBFiles", nullptr, (EPropertyFlags)0x0010000000044001, UE4CodeGen_Private::EPropertyGenFlags::Bool | UE4CodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(UAndroidRuntimeSettings), &Z_Construct_UClass_UAndroidRuntimeSettings_Statics::NewProp_bForceSmallOBBFiles_SetBit, METADATA_PARAMS(Z_Construct_UClass_UAndroidRuntimeSettings_Statics::NewProp_bForceSmallOBBFiles_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UAndroidRuntimeSettings_Statics::NewProp_bForceSmallOBBFiles_MetaData)) };
#if WITH_METADATA
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UAndroidRuntimeSettings_Statics::NewProp_bEnableGradle_MetaData[] = {
		{ "Category", "APK Packaging" },
		{ "Comment", "// Use Gradle instead of Ant for Java compiling and APK generation\n" },
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UAndroidRuntimeSettings_Statics::NewProp_TargetSDKVersion_MetaData[] = {
		{ "Category", "APK Packaging" },
		{ "Comment", "// What OS version the app is expected to run on (do not set this lower than 19)\n" },
		{ "DisplayName", "Target SDK Version (19=KitKat, 21=Lollipop)" },
		{ "ModuleRelativePath", "Classes/AndroidRuntimeSettings.h" },
		{ "ToolTip", "What OS version the app is expected to run on (do not set this lower than 19)" },
	};
#endif
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UAndroidRuntimeSettings_Statics::NewProp_MinSDKVersion_MetaData[] = {
		{ "Category", "APK Packaging" },
		{ "Comment", "// What OS version the app is allowed to be installed on (do not set this lower than 19)\n" },
		{ "DisplayName", "Minimum SDK Version (19=KitKat, 21=Lollipop)" },
		{ "ModuleRelativePath", "Classes/AndroidRuntimeSettings.h" },
		{ "ToolTip", "What OS version the app is allowed to be installed on (do not set this lower than 19)" },
	};
#endif
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UAndroidRuntimeSettings_Statics::NewProp_StoreVersionOffsetX8664_MetaData[] = {
		{ "Category", "APK Packaging" },
...
#endif
	const UE4CodeGen_Private::FIntPropertyParams Z_Construct_UClass_UAndroidRuntimeSettings_Statics::NewProp_StoreVersionOffsetX8664 = { "StoreVersionOffsetX8664", nullptr, (EPropertyFlags)0x0010000000044001, UE4CodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UAndroidRuntimeSettings, StoreVersionOffsetX8664), METADATA_PARAMS(Z_Construct_UClass_UAndroidRuntimeSettings_Statics::NewProp_StoreVersionOffsetX8664_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UAndroidRuntimeSettings_Statics::NewProp_StoreVersionOffsetX8664_MetaData)) };
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UAndroidRuntimeSettings_Statics::NewProp_StoreVersionOffsetArm64_MetaData[] = {
		{ "Category", "APK Packaging" },
...
#endif
	const UE4CodeGen_Private::FIntPropertyParams Z_Construct_UClass_UAndroidRuntimeSettings_Statics::NewProp_StoreVersionOffsetArm64 = { "StoreVersionOffsetArm64", nullptr, (EPropertyFlags)0x0010000000044001, UE4CodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UAndroidRuntimeSettings, StoreVersionOffsetArm64), METADATA_PARAMS(Z_Construct_UClass_UAndroidRuntimeSettings_Statics::NewProp_StoreVersionOffsetArm64_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UAndroidRuntimeSettings_Statics::NewProp_StoreVersionOffsetArm64_MetaData)) };
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UAndroidRuntimeSettings_Statics::NewProp_StoreVersionOffsetArmV7_MetaData[] = {
		{ "Category", "APK Packaging" },
		{ "Comment", "// Offset to add to store version for APKs generated for armv7\n" },
		{ "DisplayName", "Store Version offset (armv7)" },
		{ "ModuleRelativePath", "Classes/AndroidRuntimeSettings.h" },
		{ "ToolTip", "Offset to add to store version for APKs generated for armv7" },
	};
#endif
	const UE4CodeGen_Private::FIntPropertyParams Z_Construct_UClass_UAndroidRuntimeSettings_Statics::NewProp_StoreVersionOffsetArmV7 = { "StoreVersionOffsetArmV7", nullptr, (EPropertyFlags)0x0010000000044001, UE4CodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UAndroidRuntimeSettings, StoreVersionOffsetArmV7), METADATA_PARAMS(Z_Construct_UClass_UAndroidRuntimeSettings_Statics::NewProp_StoreVersionOffsetArmV7_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UAndroidRuntimeSettings_Statics::NewProp_StoreVersionOffsetArmV7_MetaData)) };
#if WITH_METADATA
	...
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_UAndroidRuntimeSettings_Statics::PropPointers[] = {
		...
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UAndroidRuntimeSettings_Statics::NewProp_SoundCueCookQualityIndex,
		...
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UAndroidRuntimeSettings_Statics::NewProp_CacheSizeKB,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UAndroidRuntimeSettings_Statics::NewProp_bUseAudioStreamCaching,
		...
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UAndroidRuntimeSettings_Statics::NewProp_bControllersBlockDeviceFeedback,
		...
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UAndroidRuntimeSettings_Statics::NewProp_bForceLDLinker,
		...
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UAndroidRuntimeSettings_Statics::NewProp_bSupportsVulkanSM5,
		...
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UAndroidRuntimeSettings_Statics::NewProp_PackageForOculusMobile,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UAndroidRuntimeSettings_Statics::NewProp_PackageForOculusMobile_Inner,
		...
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UAndroidRuntimeSettings_Statics::NewProp_bBundleDensitySplit,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UAndroidRuntimeSettings_Statics::NewProp_bBundleLanguageSplit,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UAndroidRuntimeSettings_Statics::NewProp_bBundleABISplit,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UAndroidRuntimeSettings_Statics::NewProp_bEnableUniversalAPK,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UAndroidRuntimeSettings_Statics::NewProp_bEnableBundle,
		...
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UAndroidRuntimeSettings_Statics::NewProp_bRestoreNotificationsOnReboot,
		...
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UAndroidRuntimeSettings_Statics::NewProp_bPublicLogFiles,
		...
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UAndroidRuntimeSettings_Statics::NewProp_bAllowPatchOBBFile,
		...
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UAndroidRuntimeSettings_Statics::NewProp_bForceSmallOBBFiles,
		...
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UAndroidRuntimeSettings_Statics::NewProp_StoreVersionOffsetX8664,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UAndroidRuntimeSettings_Statics::NewProp_StoreVersionOffsetArm64,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UAndroidRuntimeSettings_Statics::NewProp_StoreVersionOffsetArmV7,
	...
	IMPLEMENT_CLASS(UAndroidRuntimeSettings, 509062091);
